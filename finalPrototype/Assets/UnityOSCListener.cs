...
public class UnityOSCListener : MonoBehaviour  {
	...
	public void OSCMessageReceived(OSC.NET.OSCMessage message){	
		...
		float runningVol = float.Parse(args [0].ToString ());
		float scaledLight = float.Parse(args [1].ToString ());
		Debug.Log(runningVol);
		Debug.Log(scaledLight);
